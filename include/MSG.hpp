...
#define STYLE(purpose)
  (purpose == FOR_ERRORS ? STYLE_ERROR :(purpose == FOR_WARNINGS ? STYLE_WARNING : STYLE_INFO ))

#define COLOR(purpose)
  (purpose == FOR_ERRORS ? COLOR_ERROR :(purpose == FOR_WARNINGS ? COLOR_WARNING : COLOR_INFO ))
...
#define WARNING_MSG(...) do {
    fprintf( stderr, "%c[%d;%dm", 0x1B, STYLE_BOLD, COLOR_BLUE );
    fprintf( stderr, "[WARNING:: %s:%s:%d] ",__FILE__, __FUNCTION__, __LINE__ );
...
#define INFO_MSG(...) do {
    fprintf( stderr, "%c[%d;%dm", 0x1B, STYLE_BOLD, COLOR_BLUE );
    fprintf( stderr, "[ INFO  :: %s:%s:%d] ", __FILE__, __FUNCTION__, __LINE__ );
